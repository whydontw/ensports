			...
			<div class="col-xl-3 col-lg-4 col-md-5">
				<div class="sidebar-categories">
					...
					<ul class="main-categories">
						<li class="main-nav-list"><a href="${contextPath }/seoul.ba?localName=서울&currentPage=1" onclick="goToSeoulPage()"><span class="lnr lnr-arrow-right"></span><b>서울</b><span class="number"></span></a></li>

						<li class="main-nav-list"><a href="${contextPath }/gyeonggi.ba?localName=경기&currentPage=1" onclick="goToGyeonggiPage()"><span class="lnr lnr-arrow-right"></span>경기<span class="number"></span></a></li>
