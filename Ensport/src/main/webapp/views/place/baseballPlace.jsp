				...
				<div class="filter-bar d-flex flex-wrap align-items-center">
					...
					<div class="pagination">
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item"><a
									href="${contextPath }/place.ba?currentPage=${pi.currentPage-1}"
						...
						<c:forEach var="i" begin="${pi.startPage}" end="${pi.endPage }">
							<li class="page-item"><a
								href="${contextPath }/place.ba?currentPage=${i}"
						...
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item">
									<a href="${contextPath }/place.ba?currentPage=${pi.currentPage+1}" class="page-link" aria-label="Previous">
