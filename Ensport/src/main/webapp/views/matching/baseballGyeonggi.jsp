					...
					<ul class="main-categories">
						<li class="main-nav-list"><a
							href="${contextPath }/ba.seoul?localName=서울&currentPage=1"><span
								class="lnr lnr-arrow-right"></span>서울<span class="number"></span></a></li>


						<li class="main-nav-list"><a
							href="${contextPath }/ba.gyeonggi?localName=경기&currentPage=1"><span
								class="lnr lnr-arrow-right"></span><b>경기</b><span class="number"></span></a></li>
				...
				<div class="filter-bar d-flex flex-wrap align-items-center">
					<div class="sorting mr-auto"></div>
						...
						<c:choose>
									...
									<c:otherwise>
									 	<li class="page-item">
			                                <a href="${contextPath }/ba.gyeonggi?currentPage=${pi.currentPage-1}" class="page-link" aria-label="Previous">
			                                    <span aria-hidden="true">
			                                        <span class="lnr lnr-chevron-left"></span>
			                                    </span>
			                                </a>
						...
						<c:forEach var="i" begin="${pi.startPage}" end="${pi.endPage }">
		                            <li class="page-item"><a href="${contextPath }/ba.gyeonggi?currentPage=${i}" class="page-link">${i}</a></li>
						</c:forEach>								
