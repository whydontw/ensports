			...
			<div class="col-xl-3 col-lg-4 col-md-5">
				<div class="sidebar-categories">
					...
					<ul class="main-categories">
						...
						<li class="main-nav-list"><a href="${contextPath }/sc.seoul?localName=인천"><span class="lnr lnr-arrow-right"></span><b>인천</b><span class="number">(53)</span></a></li>
