<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="com.ensport.matching.*"%>
			...
			<div
				...
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="#">야구<span class="lnr lnr-arrow-right"></span></a> <a
							href="category.html">서울</a>
					</nav>
				</div>
			</div>
		</div>
				...
				<div class="sidebar-categories">
					...
					<ul class="main-categories">
						<li class="main-nav-list"><a
							href="${contextPath }/ba.seoul?localName=서울&currentPage=1"><span
								class="lnr lnr-arrow-right"></span><b>서울</b><span class="number"></span></a></li>


						<li class="main-nav-list"><a
							href="${contextPath }/ba.gyeonggi?localName=경기&currentPage=1"><span
								class="lnr lnr-arrow-right"></span>경기<span class="number"></span></a></li>

						<li class="main-nav-list"><a
							href="${contextPath }/sc.incheon?localName=인천"><span
								class="lnr lnr-arrow-right"></span>인천<span class="number"></span></a></li>
				...
				<div class="filter-bar d-flex flex-wrap align-items-center">
					<div class="sorting mr-auto"></div>
						...
						<c:choose>
									...
									<c:otherwise>
									 	<li class="page-item">
			                                <a href="${contextPath }/ba.seoul?currentPage=${pi.currentPage-1}" class="page-link" aria-label="Previous">
			                                    <span aria-hidden="true">
			                                        <span class="lnr lnr-chevron-left"></span>
			                                    </span>
			                                </a>
						...
						<c:forEach var="i" begin="${pi.startPage}" end="${pi.endPage }">
		                            <li class="page-item"><a href="${contextPath }/ba.seoul?currentPage=${i}" class="page-link">${i}</a></li>
						</c:forEach>								
	...
	$(document).ready(function() {
	    $(".single-product, #viewMore p").on("click", function(event) {
	        ...
	        if (!selectedDate || selectedDate === "날짜선택") {
	            ...
	            location.href = "detail.ba?pno=" + pno + "&date=" + selectedDate;
