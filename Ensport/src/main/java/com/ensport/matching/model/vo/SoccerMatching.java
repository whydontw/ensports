...
public class SoccerMatching {
	...
	public SoccerMatching(String filePath) {
		super();
		this.filePath = filePath;
	}
	...
	public SoccerMatching(int placeNo, String placeName, String subInfo, String placeSize, String parkingYn, Date date,
	...
	public SoccerMatching(String placeName, String changeName) {
		super();
		this.placeName = placeName;
		this.changeName = changeName;
	}
	...
	public String toString() {
		return "SoccerMatching [placeNo=" + placeNo + ", placeName=" + placeName + ", subInfo=" + subInfo
