...
public class BaseballMatchingController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		PlaceAllListCount = new SoccerMatchingService().MatchingAllListCount();
		...
		ArrayList<BaseballMatching> list = new BaseballMatchingService().selectAllBaseballMatchingList(pi);
