...
public class Place {
		...
		public Place(int reservationNo, int timeNo, int placeNo, String reservationType, Date reservationDate,
				String userCapacity, String userNo, String genderType) {
			super();
		...
		public String toString() {
			return "Place [reservationNo=" + reservationNo + ", timeNo=" + timeNo + ", placeNo=" + placeNo
