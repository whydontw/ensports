...
public class SoccerPlace {
	...
	public SoccerPlace(int placeNo, String placeName, String subInfo, String placeSize, String parkingYn,
			Date placeDate, int placeCount, String startTime, String endTime, int maxCapacity, String categoryName,
			String localName, String filePath, String changeName) {
		super();
	...
	public SoccerPlace(int placeNo, String placeName, String filePath, String changeName ) {
		super();
		this.placeNo = placeNo;
		this.placeName = placeName;
		this.filePath = filePath;
	...
	public String toString() {
		return "SoccerPlace [placeNo=" + placeNo + ", placeName=" + placeName + ", subInfo=" + subInfo + ", placeSize="
