...
/**
 * Servlet implementation class SoccerPlaceGyeonggiController
 */
@WebServlet("/gyeonggi.so")
public class SoccerPlaceGyeonggiController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SoccerPlaceGyeonggiController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		placeGyeonggiListCount = new SoccerPlaceService().allGyeonggiListCount();
		...
		ArrayList<SoccerPlace> list = new SoccerPlaceService().selectAllgyeonggiPlaceList(localName,pi);
		...
		request.getRequestDispatcher("views/place/soccerplacegyeonggi.jsp").forward(request, response);
	}
